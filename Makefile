...
SRCS =  ft_memset.c ft_strjoin.c ft_atoi.c ft_print_words_tables.c ft_strjoinf.c \
		...
		ft_itoa.c ft_putstr.c ft_strncpy.c ft_itoa_base.c ft_lstadd.c  ft_putstr_fd.c ft_strnequ.c \
		...
		ft_memdel.c  ft_striter.c ft_atoi_base.c ft_toupper.c ft_memmove.c ft_striteri.c \
